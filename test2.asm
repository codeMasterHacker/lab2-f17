...
int main(int argc, char** argv)
{
    ...
    if (argc > 1)
    1007:	ba 30 18 00 00       	mov    $0x1830,%edx
    100c:	b8 00 20 00 00       	mov    $0x2000,%eax
    1011:	83 39 01             	cmpl   $0x1,(%ecx)
#include "types.h"
#include "user.h"

int main(int argc, char** argv)
{
    1014:	ff 71 fc             	pushl  -0x4(%ecx)
    1017:	55                   	push   %ebp
    ...
    if (argc > 1)
    101c:	0f 4e c2             	cmovle %edx,%eax
#include "types.h"
#include "user.h"

int main(int argc, char** argv)
{
    101f:	89 cb                	mov    %ecx,%ebx
    int size = 6192; //6192 > 4092(PGSIZE) && 6192 < 8192(2*PGSIZE), ergo the address is to the page right under the current top of the stack
    ...
    char buffer[size];
    1021:	29 c4                	sub    %eax,%esp
    1023:	89 e2                	mov    %esp,%edx
    memset(buffer, 0, size); 
    1025:	83 ec 04             	sub    $0x4,%esp
    1028:	50                   	push   %eax
    1029:	6a 00                	push   $0x0
    102b:	52                   	push   %edx
    102c:	e8 df 00 00 00       	call   1110 <memset>
    ...
    1031:	58                   	pop    %eax
    1032:	5a                   	pop    %edx
    1033:	68 54 17 00 00       	push   $0x1754
    1038:	6a 01                	push   $0x1
    103a:	e8 c1 03 00 00       	call   1400 <printf>
    printf(1, "%p\n", &argc);
    103f:	83 c4 0c             	add    $0xc,%esp
    1042:	53                   	push   %ebx
    1043:	68 d0 17 00 00       	push   $0x17d0
    1048:	6a 01                	push   $0x1
    104a:	e8 b1 03 00 00       	call   1400 <printf>

    exit();
    104f:	e8 4e 02 00 00       	call   12a2 <exit>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    139f:	f7 f6                	div    %esi
    13a1:	0f b6 92 dc 17 00 00 	movzbl 0x17dc(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1518:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
    151b:	b8 d4 17 00 00       	mov    $0x17d4,%eax
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15a1:	a1 b8 1a 00 00       	mov    0x1ab8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  freep = p;
    15f9:	a3 b8 1a 00 00       	mov    %eax,0x1ab8
}
    15fe:	5b                   	pop    %ebx
    15ff:	5e                   	pop    %esi
    1600:	5f                   	pop    %edi
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    161d:	a3 b8 1a 00 00       	mov    %eax,0x1ab8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    163c:	8b 15 b8 1a 00 00    	mov    0x1ab8,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    if(p == freep)
    1691:	39 05 b8 1a 00 00    	cmp    %eax,0x1ab8
  ...
  return freep;
    16bb:	8b 15 b8 1a 00 00    	mov    0x1ab8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    16dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
    16df:	89 15 b8 1a 00 00    	mov    %edx,0x1ab8
      return (void*)(p + 1);
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
    16f6:	c7 05 b8 1a 00 00 bc 	movl   $0x1abc,0x1ab8
    16fd:	1a 00 00 
    1700:	c7 05 bc 1a 00 00 bc 	movl   $0x1abc,0x1abc
    1707:	1a 00 00 
    base.s.size = 0;
    170a:	b8 bc 1a 00 00       	mov    $0x1abc,%eax
    170f:	c7 05 c0 1a 00 00 00 	movl   $0x0,0x1ac0
    1716:	00 00 00 
